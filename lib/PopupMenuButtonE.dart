...
/// shows a popup menu, consider using [PopupMenuButtonE].
///
...
/// [PopupMenuItemE]), or no value at all (for example, [PopupMenuDivider]).
///
/// See also:
///
///  * [PopupMenuItemE], a popup menu entry for a single value.
///  * [PopupMenuDivider], a popup menu entry that is just a horizontal line.
///  * [CheckedPopupMenuItemE], a popup menu item with a checkmark.
///  * [showMenu], a method to dynamically show a popup menu at a given location.
///  * [PopupMenuButtonE], an [IconButton] that automatically shows a menu when
///    it is tapped.
...
/// See also:
///
///  * [PopupMenuItemE], for the kinds of items that this widget divides.
///  * [showMenu], a method to dynamically show a popup menu at a given location.
///  * [PopupMenuButtonE], an [IconButton] that automatically shows a menu when
///    it is tapped.
...
/// [CheckedPopupMenuItemE].
///
/// Typically the [child] of a [PopupMenuItemE] is a [Text] widget. More
/// elaborate menus with icons can use a [ListTile]. By default, a
/// [PopupMenuItemE] is 48 pixels high. If you use a widget with a different
...
///
/// ```dart
/// const PopupMenuItemE<WhyFarther>(
...
/// {@end-tool}
///
/// See the example at [PopupMenuButtonE] for how this example could be used in a
/// complete menu, and see the example at [CheckedPopupMenuItemE] for one way to
/// keep the text of [PopupMenuItemE]s that use [Text] widgets in their [child]
/// slot aligned with the text of [CheckedPopupMenuItemE]s or of [PopupMenuItemE]
/// that use a [ListTile] in their [child] slot.
///
/// See also:
///
///  * [PopupMenuDivider], which can be used to divide items from each other.
///  * [CheckedPopupMenuItemE], a variant of [PopupMenuItemE] with a checkmark.
///  * [showMenu], a method to dynamically show a popup menu at a given location.
///  * [PopupMenuButtonE], an [IconButton] that automatically shows a menu when
///    it is tapped.
class PopupMenuItemE<T> extends PopupMenuEntry<T> {
  /// Creates an item for a popup menu.
  ///
  /// By default, the item is [enabled].
  ///
  /// The `height` and `enabled` arguments must not be null.
  const PopupMenuItemE({
    Key key,
    this.value,
    this.enabled = true,
  ...
  @override
  PopupMenuItemEState<T, PopupMenuItemE<T>> createState() =>
      PopupMenuItemEState<T, PopupMenuItemE<T>>();
}

/// The [State] for [PopupMenuItemE] subclasses.
///
/// By default this implements the basic styling and layout of Material Design
/// popup menu items.
///
/// The [buildChild] method can be overridden to adjust exactly what gets placed
/// in the menu. By default it returns [PopupMenuItemE.child].
///
/// The [handleTap] method can be overridden to adjust exactly what happens when
/// the item is tapped. By default, it uses [Navigator.pop] to return the
/// [PopupMenuItemE.value] from the menu route.
///
/// This class takes two type arguments. The second, `W`, is the exact type of
/// the [Widget] that is using this [State]. It must be a subclass of
/// [PopupMenuItemE]. The first, `T`, must match the type argument of that widget
/// class, and is the type of values returned from this menu.
class PopupMenuItemEState<T, W extends PopupMenuItemE<T>> extends State<W> {
...
/// shows a popup menu, consider using [PopupMenuButtonE].
///
/// A [CheckedPopupMenuItemE] is 48 pixels high, which matches the default height
/// of a [PopupMenuItemE]. The horizontal layout uses a [ListTile]; the checkmark
...
///     CheckedPopupMenuItemE<Commands>(
///       checked: _heroAndScholar,
///       value: Commands.heroAndScholar,
///       child: const Text('Hero and scholar'),
///     ),
///     const PopupMenuDivider(),
///     const PopupMenuItemE<Commands>(
...
/// See also:
///
///  * [PopupMenuItemE], a popup menu entry for picking a command (as opposed to
///    toggling a value).
///  * [PopupMenuDivider], a popup menu entry that is just a horizontal line.
///  * [showMenu], a method to dynamically show a popup menu at a given location.
///  * [PopupMenuButtonE], an [IconButton] that automatically shows a menu when
///    it is tapped.
class CheckedPopupMenuItemE<T> extends PopupMenuItemE<T> {
  ...
  @override
  _CheckedPopupMenuItemEState<T> createState() =>
      _CheckedPopupMenuItemEState<T>();
}

class _CheckedPopupMenuItemEState<T>
    extends PopupMenuItemEState<T, CheckedPopupMenuItemE<T>>
...
///  * [PopupMenuDivider], a popup menu entry that is just a horizontal line.
///  * [CheckedPopupMenuItemE], a popup menu item with a checkmark.
///  * [PopupMenuButtonE], which provides an [IconButton] that shows a menu by
...
/// argument is the value of the [PopupMenuItemE] that caused its menu to be
/// dismissed.
///
/// Used by [PopupMenuButtonE.onSelected].
typedef PopupMenuItemESelected<T> = void Function(T value);

/// Signature for the callback invoked when a [PopupMenuButtonE] is dismissed
/// without selecting an item.
///
/// Used by [PopupMenuButtonE.onCanceled].
typedef PopupMenuCanceled = void Function();

/// Signature used by [PopupMenuButtonE] to lazily construct the items shown when
/// the button is pressed.
///
/// Used by [PopupMenuButtonE.itemBuilder].
typedef PopupMenuItemEBuilder<T> = List<PopupMenuEntry<T>> Function(
    BuildContext context);
...
/// then [PopupMenuButtonE] behaves like an [IconButton].
///
...
///  * [CheckedPopupMenuItemE], a popup menu item with a checkmark.
///  * [showMenu], a method to dynamically show a popup menu at a given location.
class PopupMenuButtonE<T> extends StatefulWidget {
  ...
  final PopupMenuItemEBuilder<T> itemBuilder;
  ...
  /// called instead.
  final PopupMenuItemESelected<T> onSelected;
